...
async function createImage(req, res, info) {
 const header = { text: info.name, fontName: 'Ubuntu Bold', fontSize: 20 };
 const lines = [
  { text: info.bio, fontName: 'Ubuntu Regular', fontSize: 14 },
  { text: info.login, fontName: 'Ubuntu Regular', fontSize: 18 },
  { text: info.public_repos + ' repos', fontName: 'Ubuntu Regular', fontSize: 18 },
  { text: info.public_gists + ' gists', fontName: 'Ubuntu Regular', fontSize: 18 },
  { text: info.followers + ' followers', fontName: 'Ubuntu Regular', fontSize: 18 },
  { text: info.following + ' following', fontName: 'Ubuntu Regular', fontSize: 18 },
  { text: 'Created: ' + new Date(info.created_at).toLocaleDateString(), fontName: 'Ubuntu Regular', fontSize: 16 },
 ];
